...
class HotelService(models.Model):
    '''Model that holds the all hotel service'''
    _name = 'hotel.service'
    ...
    taxes_ids = fields.Many2many('account.tax', 'Hotel_service_taxes_rel', 'service_id', 'tax_id', string='Customer Taxes', help='Default taxes used when selling the "service product"',
